...
Somewhere in that process, the role stopped being designer and started being something harder to name. Creative director is the closest thing. The person who makes every creative decision and lives with the consequences.

[workingon.studio](/) is where that plays out. For clients who need that kind of thinking, and in products built here.

I've watched the industry turn design into a performance. Metrics, frameworks, theatre. We've been convinced there's only one way to do something. That data is the answer. That the process matters more than the outcome.
