...
There is no denying that risk _and_ sentiment have changed in recent years. Companies want to be sure they are making the right choice. Finances are precariously balanced and employees are investments, so returns are expected.

But the idea of asking them to spend _their_ time, to do work _they_ love, on _your_ problem is not the way to conduct due diligence.
...
The truth is, we _don’t_ switch off. We _don’t_ stop thinking about problems the minute we step away because we _don’t_ step away.
...
## Look at their portfolio, I mean _really_ look.
...
A designer’s portfolio is the perfect way to get a feel for who they _really_ are. Their styling, their layout, their tone, their typography choices, the parts of it that have been tweaked to death.
...
## Let them talk about _their_ work instead.
...
Do not look at whether they name their layers, or how they present their working out. Design files are scratch pads, never polished, never finished. They are what some _love_ to call “living documents” (ugh, I’m off for a shower).
